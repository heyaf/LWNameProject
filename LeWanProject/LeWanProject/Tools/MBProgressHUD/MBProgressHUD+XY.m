...
+ (MBProgressHUD*)createMBProgressHUDviewWithMessage:(NSString*)message isWindiw:(BOOL)isWindow
{
    ...
    UIView  *view = isWindow? (UIView*)[UIApplication sharedApplication].delegate.window:(UIViewController *)([kAppDelegate getCurrentUIVC]).view;
