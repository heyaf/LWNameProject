...
@interface LWNameDetailViewController ()<GDTNativeExpressProAdManagerDelegate, GDTNativeExpressProAdViewDelegate,CQScrollMenuViewDelegate,GDTNativeExpressRewardedVideoAdDelegate,UITableViewDelegate,UITableViewDataSource>
